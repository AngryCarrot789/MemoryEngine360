...
public abstract class BaseXDevkitRemoteCommand : BaseRemoteConsoleCommand {
    ...
    protected abstract Task ExecuteRemoteCommandInActivity(MemoryEngine360 engine, XDevkitConsoleConnection connection, CommandEventArgs e);
}
...
public class XboxRunningProcessCommand : BaseXDevkitRemoteCommand {
    ...
    protected override async Task ExecuteRemoteCommandInActivity(MemoryEngine360 engine, XDevkitConsoleConnection connection, CommandEventArgs e) {
