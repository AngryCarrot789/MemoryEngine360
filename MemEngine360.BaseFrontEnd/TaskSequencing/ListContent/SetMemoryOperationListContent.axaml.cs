...
public partial class SetMemoryOperationListContent : BaseOperationListContent {
    ...
    private readonly IBinder<SetMemoryOperation> addressBinder = new TextBoxToEventPropertyBinder<SetMemoryOperation>(nameof(SetMemoryOperation.AddressChanged), (b) => b.Model.Address.ToString("X8"), (b, text) => BinderParsingUtils.TryParseAddress(text, b, (a, v) => a.Model.Address = v));
