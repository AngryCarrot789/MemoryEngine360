...
public class AutoRefreshLayer : Layer {
    ...
    /// </summary>
    public static readonly StyledProperty<IPen?> PrimarySelectionBorderProperty = AvaloniaProperty.Register<AutoRefreshLayer, IPen?>(nameof(PrimarySelectionBorder), new Pen(Brushes.DarkRed));

    /// <summary>
    /// Defines the <see cref="PrimarySelectionBorder"/> property.
    /// </summary>
    public static readonly StyledProperty<IBrush?> PrimarySelectionBackgroundProperty = AvaloniaProperty.Register<AutoRefreshLayer, IBrush?>(nameof(PrimarySelectionBackground), new SolidColorBrush(Colors.DarkRed, 0.5D));

    /// <summary>
    /// Defines the <see cref="PrimarySelectionBorder"/> property.
    /// </summary>
    public static readonly StyledProperty<IPen?> SecondarySelectionBorderProperty = AvaloniaProperty.Register<AutoRefreshLayer, IPen?>(nameof(PrimarySelectionBorder), new Pen(Brushes.DarkRed));

    /// <summary>
    /// Defines the <see cref="PrimarySelectionBorder"/> property.
    /// </summary>
    public static readonly StyledProperty<IBrush?> SecondarySelectionBackgroundProperty = AvaloniaProperty.Register<AutoRefreshLayer, IBrush?>(nameof(SecondarySelectionBackgroundProperty), new SolidColorBrush(Colors.DarkRed, 0.25D));
