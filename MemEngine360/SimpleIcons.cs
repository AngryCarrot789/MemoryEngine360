...
public static class SimpleIcons {
    ...
    public static readonly Icon DownloadMemoryIcon =
        IconManager.Instance.RegisterGeometryIcon(
            ...
            [
                new GeometryEntry("M 0 2 L 16 2 L 16 14 L 0 14 Z", BrushManager.Instance.CreateConstant(SKColors.MediumSeaGreen)),
                new GeometryEntry("M 2 0 L 4 0 L 4 2 L 2 2 Z M 12 0 L 14 0 L 14 2 L 12 2 Z Z Z Z Z M 2 14 L 4 14 L 4 16 L 2 16 Z M 12 14 L 14 14 L 14 16 L 12 16 Z Z M 7 2 L 7 0 L 9 0 L 9 2 L 7 2 M 7 14 L 7 16 L 9 16 L 9 14 L 7 14", BrushManager.Instance.CreateConstant(SKColors.Gold)),
                new GeometryEntry("M14.5858 24.0711 20.5962 18.0607 20.5962 15.9393 16.5858 15.9393 16.5858 7.1005 12.5858 7.1005 12.5858 15.9393 8.5754 15.9393 8.5754 18.0607 14.5858 24.0711Z", DynamicGlyphBrush)
            ], stretch: StretchMode.Uniform);
    ...
    public static readonly Icon ConnectToConsoleIcon =
        IconManager.Instance.RegisterGeometryIcon(
            ...
            [
                ...
                new GeometryEntry("M24 14H15.5L14 15.5 16.8358 18.3358 10.5858 24.5858 13.4142 27.4142 19.6642 21.1642 22.5 24 24 22.5 24 14Z", DynamicGlyphBrush),
            ],
            stretch: StretchMode.Uniform);
    ...
    public static readonly Icon DeleteAllRowsIcon =
        IconManager.Instance.RegisterGeometryIcon(
            ...
            [
                new GeometryEntry("M10 12.6l.7.7 1.6-1.6 1.6 1.6.8-.7L13 11l1.7-1.6-.8-.8-1.6 1.7-1.6-1.7-.7.8 1.6 1.6-1.6 1.6zM1 4h14V3H1v1zm0 3h14V6H1v1zm8 2.5V9H1v1h8v-.5zM9 13v-1H1v1h8z", DynamicGlyphBrush),
            ],
            stretch: StretchMode.Uniform);
    ...
    public static readonly Icon DeleteRowIcon =
        IconManager.Instance.RegisterGeometryIcon(
            ...
            [
                new GeometryEntry("M.3789 6.1563C.1689 6.1563 0 6.3895 0 6.6797v4.7949C0 11.7647.1689 12 .3789 12H13.6211c.2101 0 .3789-.2353.3789-.5254V6.6797c0-.2902-.1688-.5234-.3789-.5234H.3789zm.6797 1.2109h3.2148v3.4219H1.0586V7.3672zm4.2832 0h3.2148v3.4219H5.3418V7.3672zm4.2832 0h3.2168v3.4219H9.625V7.3672z", DynamicGlyphBrush),
    ...
    public static readonly Icon CopyHexSelectionToRefreshRangeIcon =
        IconManager.Instance.RegisterGeometryIcon(
            ...
            [
                new GeometryEntry("M.5.55.5 9.05 2 10.55 4.8358 7.7142 11.0858 13.9642 13.9142 11.1358 7.6642 4.8858 10.5 2.05 9 .55.5.55Z", DynamicGlyphBrush),
            ],
            stretch: StretchMode.Uniform);
    ...
    public static readonly Icon ClearHexRefreshRangeIcon =
        IconManager.Instance.RegisterGeometryIcon(
            ...
            [
                new GeometryEntry("M42.5056 42.0889l-2.9444-16.9778H40.5556c.8 0 1.4444-.6444 1.4444-1.4444V13c0-.8-.6444-1.4444-1.4444-1.4444H26.8889V1.4444c0-.8-.6444-1.4444-1.4444-1.4444H16.5556c-.8 0-1.4444.6444-1.4444 1.4444v10.1111H1.4444c-.8 0-1.4444.6444-1.4444 1.4444v10.6667c0 .8.6444 1.4444 1.4444 1.4444h.9944l-2.9444 16.9778c-.0167.0833-.0222.1667-.0222.2444 0 .8.6444 1.4444 1.4444 1.4444h40.1667c.0833 0 .1667-.0056.2444-.0222.7889-.1333 1.3167-.8833 1.1778-1.6667zM3.8889 15.4444h15.1111V3.8889h4v11.5556h15.1111v5.7778H3.8889V15.4444zm26 24.4444V31.2222c0-.2444-.2-.4444-.4444-.4444h-2.6667c-.2444 0-.4444.2-.4444.4444v8.6667H15.6667V31.2222c0-.2444-.2-.4444-.4444-.4444h-2.6667c-.2444 0-.4444.2-.4444.4444v8.6667H3.8222l2.5056-14.4444H35.6667l2.5056 14.4444H29.8889z", DynamicGlyphBrush),
            ],
            stretch: StretchMode.Uniform);
    ...
    public static readonly Icon SaveFileIcon =
        IconManager.Instance.RegisterGeometryIcon(
            nameof(SaveFileIcon),
            [
                new GeometryEntry("M424.229 12.854 424.229 204.8 87.771 204.8 87.771 0 0 0 0 512 87.771 512 87.771 307.2 424.229 307.2 424.229 512 512 512 512 100.626z", DynamicGlyphBrush),
                new GeometryEntry("M131.657,351.086V512h248.686V351.086H131.657z M329.143,446.171H182.857v-43.886h146.286V446.171z", DynamicGlyphBrush),
                new GeometryEntry("M131.657,0v160.914h248.686V0H131.657z M204.8,124.343h-43.886V51.2H204.8V124.343z", DynamicGlyphBrush),
            ],
            stretch: StretchMode.Uniform);
