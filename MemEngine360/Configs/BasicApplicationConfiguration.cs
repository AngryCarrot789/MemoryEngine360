...
public class BasicApplicationConfiguration : PersistentConfiguration {
    ...
    public static readonly PersistentProperty<uint> EndAddressProperty = PersistentProperty.RegisterParsable<uint, BasicApplicationConfiguration>("EndAddress", defaultValue: 0x8000FFFF, owner => owner.endAddr, (x, y) => x.endAddr = y, false);
    ...
    private uint endAddr = EndAddressProperty.DefaultValue;
    ...
    public uint EndAddress {
        get => EndAddressProperty.GetValue(this);
        set => EndAddressProperty.SetValue(this, value);
    }
