...
public class HexEditorInfo : ITransferableData {
    ...
    public static readonly DataParameterNumber<uint> OffsetParameter = DataParameter.Register(new DataParameterNumber<uint>(typeof(HexEditorInfo), nameof(Offset), 0x82000000, ValueAccessors.Reflective<uint>(typeof(HexEditorInfo), nameof(offset))));
    ...
    private uint offset;
    private uint autoRefreshStartAddress;
    private uint autoRefreshLength;
    ...
    public uint Offset {
        get => this.offset;
        set => DataParameter.SetValueHelper(this, OffsetParameter, ref this.offset, value);
    }
