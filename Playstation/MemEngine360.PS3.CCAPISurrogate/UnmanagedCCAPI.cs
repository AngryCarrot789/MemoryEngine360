...
public sealed class UnmanagedCCAPI {
    ...
    private UnmanagedCCAPI(Natives natives) {
        this.natives = natives;
    }

    public static UnmanagedCCAPI LoadLibrary(string libraryPath) {
        IntPtr hLibrary;
        try {
        ...
        return new UnmanagedCCAPI(new Natives {
            Library = hLibrary,
    ...
    public void Dispose() {
        Natives? n = Interlocked.Exchange(ref this.natives, null);
        if (n != null && n.Library != IntPtr.Zero) {
            NativeLibrary.Free(n.Library);
        }
    }

    private sealed class Natives {
        public required IntPtr Library;
        public required CCAPIConnectConsole_t CCAPIConnectConsole;
        public required CCAPIDisconnectConsole_t CCAPIDisconnectConsole;
        public required CCAPIGetConnectionStatus_t CCAPIGetConnectionStatus;
        public required CCAPISetBootConsoleIds_t CCAPISetBootConsoleIds;
        public required CCAPISetConsoleIds_t CCAPISetConsoleIds;
        public required CCAPISetMemory_t CCAPISetMemory;
        public required CCAPIGetMemory_t CCAPIGetMemory;
        public required CCAPIGetProcessList_t CCAPIGetProcessList;
        public required CCAPIGetProcessName_t CCAPIGetProcessName;
        public required CCAPIGetTemperature_t CCAPIGetTemperature;
        public required CCAPIShutdown_t CCAPIShutdown;
        public required CCAPIRingBuzzer_t CCAPIRingBuzzer;
        public required CCAPISetConsoleLed_t CCAPISetConsoleLed;
        public required CCAPIGetFirmwareInfo_t CCAPIGetFirmwareInfo;
        public required CCAPIVshNotify_t CCAPIVshNotify;
        public required CCAPIGetNumberOfConsoles_t CCAPIGetNumberOfConsoles;
        public required CCAPIGetConsoleInfo_t CCAPIGetConsoleInfo;
        public required CCAPIGetDllVersion_t CCAPIGetDllVersion;
    }
