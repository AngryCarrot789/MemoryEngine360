...
internal class ProcessListBoxItem : ModelBasedListBoxItem<Ps3Process> {
    ...
    protected override void OnAddedToList() {
        this.Content = $"{this.Model!.ProcessName} ({this.Model!.ProcessId:X8})"; // TODO: use something other than content
    }
